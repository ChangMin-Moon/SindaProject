	...
	<div class="container">
		<div class="row" align="center">
			<%
				...
				ResultSet rs = null;
				String sql = "select * from product where p_name like ? or p_description like ? or p_category like ?";
			...
			%>
					<div class="col-md-4">
						<a href='./product.jsp?id=<%=rs.getString("p_id")%>' role="button"><img src='${pageContext.request.contextPath }/images/<%=rs.getString("p_img")%>' style="width: 200px; height : 200px"></a>
