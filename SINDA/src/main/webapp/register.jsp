...
<div class="container">
	...
	<form name="register" action="register_ok.jsp" method="post" class="form-horizontal">
		<div class="form-group row">
			<label class="col-sm-2"><span class="text text-danger">*</span> 아이디 </label>
			<div class="col-sm-3">
				<input type="text" name="m_id" autofocus class="form-control" onkeydown="input_id_check()"> 
			</div>
			<div class="col-sm-3">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="text" name="m_ssn" maxlength="8" size="8" class="form-control">
			</div>
		</div>
		<div class="form-group row">
			...
			@
			<div class="col-sm-3">
				<input type="text" name="m_email2" class="form-control">
			</div>
			<div class="col-sm-3">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				...
				<%for(int i = 230; i>=230 && i<=280; i+=5){%>
					<option class="form-control" value="<%=i%>" id="sizecheck"><%=i%></option>
				<%}%>
				</select>
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="text" name="m_zipcode" size="5"  maxlength="5" class="form-control"  onclick="search_addr()" readonly> 
			</div>
			<div class="col-sm-3">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="text" name="m_addr1" size="50" class="form-control" onclick="search_addr()" readonly>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="text" name="m_addr2" size="50" class="form-control">
			</div>
		</div>
